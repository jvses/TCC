...
\input{editaveis/2-aspectosgerais}
\input{editaveis/3-consideracoes}
\input{editaveis/4-textoepostexto}
\input{editaveis/5-elementosdotexto}
\input{editaveis/6-elementosdopostexto}
